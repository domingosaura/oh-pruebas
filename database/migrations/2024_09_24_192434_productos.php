...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('productos', function (Blueprint $table) {
            $table->comment('esta es la tabla de datos de las plantillas de las galerias');
            $table->increments('id');
            ...
            $table->boolean('selopc1')->default(false); // aqui no vale para nada pero bueno lo dejaré de momento
        ...
        DB::statement("alter table productos change column binario binario longblob null");
    }
