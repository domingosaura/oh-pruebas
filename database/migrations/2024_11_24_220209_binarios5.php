...
return new class extends Migration
{
    ...
    {
        Schema::create('binarios5', function (Blueprint $table) {
            $table->increments('id');
        ...
        DB::statement("alter table binarios5 change column binario binario longblob null");
        DB::statement("alter table binarios5 change column binariomin binariomin longblob null");
    }
