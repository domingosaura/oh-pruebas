...
return new class extends Migration
{
    ...
    {
        Schema::create('pproductos', function (Blueprint $table) {
            $table->comment('esta es la tabla de datos de los productos (la base)');
            $table->increments('id');
        ...
        DB::statement("alter table pproductos change column binario binario longblob null");
    }
