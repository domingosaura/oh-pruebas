...
return new class extends Migration
{
    ...
    {
        Schema::create('pgalerias', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->date('caducidad')->nullable(); // fecha caducidad desde que se comparte - rellenable en galeria
            $table->integer('diascaducidad')->nullable()->default(7); // dias de caducidad desde que se comparte - rellenable en plantilla
            ...
            $table->integer('diascaducidaddescarga')->nullable()->default(30); // NO USADO dias de caducidad desde que se comparte - rellenable en galeria
        ...
        DB::statement("alter table pgalerias change column binario binario longblob null");
        DB::statement("alter table pgalerias change column binariomin binariomin longblob null");
    }
