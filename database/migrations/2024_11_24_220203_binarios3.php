...
return new class extends Migration
{
    ...
    {
        Schema::create('binarios3', function (Blueprint $table) {
            $table->increments('id');
        ...
        DB::statement("alter table binarios3 change column binario binario longblob null");
        DB::statement("alter table binarios3 change column binariomin binariomin longblob null");
    }
