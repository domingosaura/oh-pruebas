...
return new class extends Migration
{
    ...
    {
        Schema::create('binarios', function (Blueprint $table) {
            $table->increments('id');
        ...
        DB::statement("alter table binarios change column binario binario longblob null");
        DB::statement("alter table binarios change column binariomin binariomin longblob null");
    }
