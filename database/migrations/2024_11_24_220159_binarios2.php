...
return new class extends Migration
{
    ...
    {
        Schema::create('binarios2', function (Blueprint $table) {
            $table->increments('id');
        ...
        DB::statement("alter table binarios2 change column binario binario longblob null");
        DB::statement("alter table binarios2 change column binariomin binariomin longblob null");
    }
