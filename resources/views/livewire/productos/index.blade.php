        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Productos para galerías</h5>
                </div>
                ...
                <div class="col-12 text-end">
                    <a class="btn bg-gradient-dark mb-0 me-4" wire:click="nuevoregistro"><i
                            class="material-icons text-sm">add</i>&nbsp;&nbsp;Nuevo producto</a>
                </div>
                ...
                <x-table>
                    <x-slot name="head">
                        ...
                        <x-table.heading sortable wire:click="sortBy('nombre')"
                            :direction="$sortField === 'nombre' ? $sortDirection : null">Descripción
                        </x-table.heading>
                    ...
                    <x-slot name="body">
                        ...
                        <x-table.row wire:key="row-{{ $tag->id }}">
                            ...
                            <x-table.cell><a href="{{ route('edit-productos', $tag)}}">{{ $tag->nombre }}</a></x-table.cell>
                            <x-table.cell>{{ Utils::datetime($tag->created_at) }}</x-table.cell>
                            <x-table.cell>
                                <a rel="tooltip" class="btn botonoh_negro"
                                    href="{{ route('edit-productos', $tag)}}" data-original-title=""
                                    title="Editar">
                                    <i class="material-icons">edit</i>
                                </a>
                                <button type="button" class="btn botonoh_negro" data-original-title="" title="Copia de este producto"
