                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mt-2 mt-md-0">
                        <div class="card">
                            <div class="card-body p-3">
                                ...
                                <p class="text-sm mt-3"> Pink is obviously a better color. Everyone’s born confident,
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mt-2">
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="d-flex mt-n2">
                                    <div class="avatar avatar-xl bg-gradient-dark border-radius-xl p-2 mt-n4">
                                        <img src="{{ asset('assets') }}/img/small-logos/logo-xd.svg" alt="xd_logo">
                                    </div>
                                    <div class="ms-3 my-auto">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mt-2">
                        <div class="card">
                            <div class="card-body p-3">
                                ...
                                <p class="text-sm mt-3"> We strive to embrace and drive change in our industry. We are
                                    happy to work at such a project. </p>
                                <hr class="horizontal dark">
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class="text-sm mb-0">4</h6>
