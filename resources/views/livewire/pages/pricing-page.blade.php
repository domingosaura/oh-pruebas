        ...
        <div class="card mt-n8">
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-lg-0 mb-4">
                                <div class="card shadow-lg">
                                    <span
                                        class="badge rounded-pill bg-light text-dark w-30 mt-n2 mx-auto">Starter</span>
                                    <div class="card-header text-center pt-4 pb-3">
                                        <h1 class="font-weight-bold mt-2">
                                            <small class="text-lg align-top me-1">$</small>59<small
                                ...
                                <div class="card bg-gradient-dark shadow-lg">
                                    ...
                                    <div class="card-header text-center pt-4 pb-3 bg-transparent">
                                        <h1 class="font-weight-bold mt-2 text-white">
                                            <small class="text-lg align-top me-1">$</small>89<small
                                                class="text-lg">/mo</small>
                                        </h1>
                                    </div>
                                    <div class="card-body text-lg-start text-center pt-0">
                            ...
                            <div class="col-lg-4 mb-lg-0 mb-4">
                                <div class="card shadow-lg">
                                    <span
                                        class="badge rounded-pill bg-light text-dark w-30 mt-n2 mx-auto">Enterprise</span>
                                    <div class="card-header text-center pt-4 pb-3">
                                        <h1 class="font-weight-bold mt-2">
            ...
            <div class="row mt-4 mx-5">
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <img class="w-100 opacity-9" src="{{ asset('assets') }}/img/logos/gray-logos/logo-coinbase.svg"
                        alt="logo_coinbase">
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <img class="w-100 opacity-9" src="{{ asset('assets') }}/img/logos/gray-logos/logo-nasa.svg"
                        alt="logo_nasa">
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <img class="w-100 opacity-9" src="{{ asset('assets') }}/img/logos/gray-logos/logo-netflix.svg"
                        alt="logo_netflix">
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <img class="w-100 opacity-9" src="{{ asset('assets') }}/img/logos/gray-logos/logo-pinterest.svg"
                        alt="logo_pinterest">
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <img class="w-100 opacity-9" src="{{ asset('assets') }}/img/logos/gray-logos/logo-spotify.svg"
                        alt="logo_spotify">
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <img class="w-100 opacity-9" src="{{ asset('assets') }}/img/logos/gray-logos/logo-vodafone.svg"
                        alt="logo_vodafone">
                </div>
            </div>
            <div class="row mt-5">
