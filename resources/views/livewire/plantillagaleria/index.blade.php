        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Plantillas para galerías</h5>
                </div>
                ...
                <x-table>
                    ...
                    <x-slot name="body">
                        ...
                        <x-table.row wire:key="row-{{ $tag->id }}">
                            ...
                            <x-table.cell><a href="{{ route('edit-plantillagaleria', $tag)}}">{{ $tag->nombreinterno?$tag->nombreinterno:$tag->nombre }}</a></x-table.cell>
                            <x-table.cell>{{ Utils::datetime($tag->created_at) }}</x-table.cell>
                            <x-table.cell>
                                <a rel="tooltip" class="btn botonoh_negro"
                                    href="{{ route('edit-plantillagaleria', $tag)}}" data-original-title=""
                                    title="Editar">
