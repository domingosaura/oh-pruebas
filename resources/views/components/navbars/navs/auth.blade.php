...
<nav class="navbar navbar-main navbar-expand-lg xxposition-sticky mt-2 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
    ...
    -->
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav justify-content-end align-items-center">
               <!-- 
                <li class="nav-item">
                    <a href="{ { route('illustra tion-sign-in') } }" class="nav-link text-body p-0 position-relative"
                        target="_blank">
            ...
            -->
                ...
                <li class="nav-item px-3">
                    <p class="negrita">{{ auth()->user()->name }}</p>
                </li>
                <!--
                <li class="nav-item px-3">
                    <a href="javascript:;" class="nav-link text-body p-0">
                ...
                -->
                <li class="nav-item dropdown pe-2 oculto">
